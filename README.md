...
******Upon running this app you may see INVALID CLIENT ID displayed in the browser. If this happens type in http://localhost:3000/ to be redirected to the app. I am still working to fix this.***
